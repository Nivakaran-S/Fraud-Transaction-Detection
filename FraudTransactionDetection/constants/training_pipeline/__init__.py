...
TARGET_COLUMN="Class"
PIPELINE_NAME:str = "FraudTransactionDetection"
...
DATA_INGESTION_COLLECTION_NAME: str="TransactionData"
DATA_INGESTION_DATABASE_NAME: str="NIVAKARANS"
...
TRAINING_BUCKET_NAME="fraudtransaction28"